...
This lab is for ServiceNow internal only
Access to [hermes1](https://hermes1.service-now.com/); request can be opened via https://tinyurl.com/WDFIntakeForm

Recommended pre-requisites, this will reduce effort in building the Producer:
Get a Docker account which can be created for free via https://www.docker.com/
Install Docker Desktop via https://docs.docker.com/desktop/
Pull the apache/kafka latest image (add screenshot)
Go to Images, run the Docker Image, accept defaults
Go to Containers and see the newly created container with a randomized name
This will be the image you will use for Part X. Alternatively you can execute all of the steps in Part X in your local machine
